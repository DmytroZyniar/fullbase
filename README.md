...
Асинхронний Telegram-бот на `python-telegram-bot` з командами `/start`, `/help`, `/search`, `/menu`, `/history`, `/export`, `/lang`.
...
## Можливості
- Асинхронні команди
- Кнопкове меню (Inline Keyboard) для взаємодії без ручного вводу команд
...
- Багато пошукових профілів/посилань: соціальні мережі, маркетплейси, довідники, пошукові системи
